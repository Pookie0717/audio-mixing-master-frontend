    ...
    useEffect(() => {
        const fetchOrder = async () => {
            try {
                ...
                setRevisions(orderData.revision || []); // Ensure revisions is always an array
                setLoading(false);
                                                                    ...
                                                                    {getRevisionsForItem(item.service_id)
                                                                        ...
                                                                        .map((revision) => (
                                                                            <div key={revision.id} className="p-4 bg-gray-800 rounded-lg mt-5 flex flex-col gap-2">
                                                                                ...
                                                                                <p className="font-THICCCBOI-Medium text-lg">
                                                                                    <strong>Created At:</strong> {new Date(revision.createdAt).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                                                                                </p>
                                                                            </div>
                                                                        ))}
                                                                </div>
